  ...
  export default function ArrivedModule({ setRouteState }) {
    ...
    async function handleCaptureProof() {
      ...
      try {
        ...
        formData.append('photo', photo, `pickup-${currentStopIndex}-${Date.now()}.jpg`)
        formData.append('note', note.trim())
        formData.append('collected_at', new Date().toISOString())
        if (sessionStorage.getItem('ww_gps_lat'))
          formData.append('lat', sessionStorage.getItem('ww_gps_lat'))
        if (sessionStorage.getItem('ww_gps_lng'))
          formData.append('lng', sessionStorage.getItem('ww_gps_lng'))
